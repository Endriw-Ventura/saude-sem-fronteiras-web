...
export default function UserFormConfirmation({ createUser, handleConfirmation, handlePreviousStep }: multiStepFormThreeProps){
    return(
         <div className='flex flex-col justify-around w-full h-screen p-[10%]'>
            ...
            <p>Previous Cirurgies: {createUser.userInfo.previousCirurgies ? "Yes" : "No"}</p>
