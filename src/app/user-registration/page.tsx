...
const updateUser = (name: string, value: string | boolean) => {
  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return (
         <UserFormStepOne createUser={createUser} handleInputChange={handleInputChange} handleNextStep={nextStep} />
        );
      case 2:
        return (
        <UserFormStepTwo createUser={createUser} handleInputChange={handleInputChange} handleNextStep={nextStep} handlePreviousStep={prevStep} />
        );
      case 3:
        return (
        <UserFormStepThree createUser={createUser} 
      ...
      case 4:
        return (
         <UserFormConfirmation handleConfirmation={confirmation} createUser={createUser} {...confirmation} handlePreviousStep={prevStep}/>
        );
      default:
        return <></>;
    }
